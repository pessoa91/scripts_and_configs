  (xbindkey '("XF86AudioRaiseVolume") "amixer sset Master 2%+ ; amixer set Master unmute")
  (xbindkey '("XF86AudioLowerVolume") "amixer sset Master 2%- ; amixer set Master unmute")
